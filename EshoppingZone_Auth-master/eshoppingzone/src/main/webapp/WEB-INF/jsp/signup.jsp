...
<body>
	<form class="modal-content" action="/profilecreation"
		onsubmit="return fun()" method="post">
		<div class="container">
			<h1>Sign Up</h1>
			<p>Please fill in this form to create an account.</p>
			<hr>
			<label ><b>User Name</b></label> 
			<input id="username" type="text" placeholder="Enter UserName" name="fullName" autofocus="autofocus" required>
			<label for="mobileno"><b>Mobile Number</b></label> 
			<input id="mobileNumber" type="text" placeholder="Enter Mobile Number" name="mobilenumber" required> 

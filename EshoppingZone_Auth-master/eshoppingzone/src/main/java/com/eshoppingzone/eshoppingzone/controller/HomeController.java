...
public class HomeController {
	...
	@RequestMapping(value="/profilecreation",method=RequestMethod.POST)
	public String creatingProfile(@RequestParam("fullName") String fullName,@RequestParam("mobilenumber") Long mobilenumber,
	...
	{
		Orders orders=restTemplate.getForObject("http://10.246.92.126:9090/orders/order" + currentProfile.getProfileId(),Orders.class);
		System.out.println("orders"+orders);
		return new ModelAndView("viewprofile","orders",orders);
	}
	...
	public ModelAndView viewWallet()
	{
		...
		return new ModelAndView("viewprofile","wallet",balance);
	}
